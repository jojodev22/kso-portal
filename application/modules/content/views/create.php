                ...
                <div class="card-body">
                    <?= form_open(); ?>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input  type="text" class="form-control <?= form_error('name') == true ? 'invalid' : '' ?>" name="name" id="name" placeholder="Masukan nama judul...">
                                <?= form_error('name') ?>
                            </div>
                        </div>
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input  type="text" class="form-control <?= form_error('url') == true ? 'invalid' : '' ?>" name="url" id="url" placeholder="Masukan URL...">
                                <?= form_error('url') ?>
                            </div>
                        </div>
                        <div class="row mb-3">
