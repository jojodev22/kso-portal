...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
  <div class="app-brand demo ">
    ...
    <span class="app-brand-logo demo">
      ...
      <span class="app-brand-text demo menu-text fw-bold ms-2 text-uppercase">PORTAL</span>
    </a>
  ...
  <ul class="menu-inner py-1">
    ...
    <li class="menu-item <?= activeMenu('content') ?>">
      <a href="<?= base_url('content') ?>" class="menu-link">
        <i class="menu-icon tf-icons bx bx-book-content"></i>
        <div class="text-truncate" data-i18n="Basic">Content</div>
      </a>
    </li>
    <li class="menu-item">
      <a href="<?= base_url('content') ?>" class="menu-link">
